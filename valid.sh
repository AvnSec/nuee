...
# By Malhadi Jr.
# Recoded by MRCk222 From IDLive
#set -x
NC='\033[0m'
GREEN='\e[38;5;82m'
CYAN='\e[38;5;45m'
...
printf "${CYAN}##############################################\n"
printf "\e[38;5;82m#######\                     #######\           ## |\n"
printf "\e[38;5;82m##  __##\                    ##  __##\          ## |\n"
printf "\e[38;5;82m## |  ## |######\  ##\   ##\ ## |  ## |######\  ## |\n"
printf "\e[38;5;82m#######  |\____##\ ## |  ## |#######  |\____##\ ## |\n"
printf "\e[38;5;82m##  ____/ ####### |## |  ## |##  ____/ ####### |## |\n"
printf "\e[38;5;82m## |     ##  __## |## |  ## |## |     ##  __## |## |\n"
printf "\e[38;5;82m## |     \####### |\####### |## |     \####### |## |\n"
printf "\e[38;5;82m\__|      \_______| \____## |\__|      \_______|\__|\n"
printf "\e[38;5;82m                   ##\   ## |\n"
printf "\e[38;5;82m                   \######  |\n"
printf "\e[38;5;82m                    \______/\n"
printf "${RED}"
printf "==============================================\n"
printf "${NC}         NyenderID - PP Valid v1         \n"
printf "${RED}==============================================${NC}\n\n"
usage() { 
...
malhadi_request() {
  ...
  posted=`curl "https://www.paypal.com/cgi-bin/webscr" --data "item_name=Sunbury$RAND.COM+-+Monthly+Email+Address&p3=1&t3=Y&cmd=_xclick-subscriptions&currency_code=AUD&sra=1&src=1&business=$1" --compressed -D - -s --cookie-jar cookiejar.txt --cookie cookie.txt`
  duration=$SECONDS
